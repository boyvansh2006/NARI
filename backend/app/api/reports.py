...
async def upload_report(
    ...
    pipeline."""
    return await ReportService(session).upload_report(file)
...
async def list_reports(
    ...
    return await ReportService(session).list_reports(page=page, page_size=page_size)
...
async def get_report(
    ...
    return await ReportService(session).get_report(report_id)
...
async def delete_report(
    ...
    return await ReportService(session).delete_report(report_id)
